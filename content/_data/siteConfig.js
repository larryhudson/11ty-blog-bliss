...
module.exports = {
  ...
  site: {
    ...
    description:
      'Software engineer at CO2 AI, figuring out how engineering teams actually work with AI. Reading, building and thinking out loud.',
    ...
    url: process.env.URL || 'https://larryhudson.io/',
    ...
    fediverse: [
      {
        ...
        url: 'https://indieweb.social/@larryhudson',
      },
    ],
  },
  // ---------------------------------------------------------------------------
  ...
  metaPages: [
    ...
    {
      url: 'https://last.fm/user/harryludson',
      title: 'Last.fm',
    },
  ],
  // ---------------------------------------------------------------------------
